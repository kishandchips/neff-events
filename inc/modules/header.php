<?php 
	...
	$logotype = ( !empty($logotype) ) ? $logotype : get_field('header_logo_type', $page_id );
 ...
 ?>
<div id="header" <?php if($image): ?>style="background: url(<?php echo $image; ?>) center top no-repeat"<?php endif; ?> class="<?php echo $logotype; ?>">
